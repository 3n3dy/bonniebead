...
export default function Hero() {
  ...
  return (
    <>
      ...
      <section className="relative overflow-hidden max-w-screen-xl mx-auto px-6 md:px-12 pt-16 pb-20 md:pt-24 md:pb-28">
        <div
          ...
          <div className="grid grid-cols-12 gap-4 items-end">
            <div className="col-span-12 md:col-span-8">
              ...
              <h1 className="font-display text-5xl md:text-7xl lg:text-[5.5rem] leading-[1.05] tracking-tight text-stone-950">
                <span className="font-normal">{t('hero.title_1')}</span>
                <br />
